...
//Check Element
WebUI.verifyElementPresent(findTestObject('Object Repository/Homepage menu/calender/left'), 10)
WebUI.click(findTestObject('Object Repository/Homepage menu/calender/left'))
