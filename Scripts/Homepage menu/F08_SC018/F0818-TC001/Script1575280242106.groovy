...
WebUI.click(findTestObject('Homepage menu/Article Search Objects/input_Article'))

WebUI.setText(findTestObject('Homepage menu/Article Search Objects/input_Article'), 'ร้านกาแฟ ม.พะเยา ผุดไอเดีย ใช้หูหิ้วไม้ไผ่ ลดการใช้พลาสติกในมหาวิทยาลัย')

WebUI.sendKeys(findTestObject('Homepage menu/Article Search Objects/input_Article'), '')
