...
WebUI.click(findTestObject('Homepage menu/AllNews Search Objects/input_AllNews'))

WebUI.setText(findTestObject('Homepage menu/AllNews Search Objects/input_AllNews'), 'SEEN จัดโครงการเข้าค่ายสิ่งแวดล้อมและพลังงาน')

WebUI.sendKeys(findTestObject('Homepage menu/AllNews Search Objects/input_AllNews'), '')

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Homepage menu/AllNews Search Objects/a_AllNewsTitle'), 20)

WebUI.verifyElementPresent(findTestObject('Homepage menu/AllNews Search Objects/img_AllNews'), 20)
