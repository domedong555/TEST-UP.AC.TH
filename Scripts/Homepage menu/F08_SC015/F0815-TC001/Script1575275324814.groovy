...
WebUI.click(findTestObject('Homepage menu/News Active select page/a_btn3'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Homepage menu/News Active select page/Search Result/a_page3'), 
    20)

WebUI.verifyElementPresent(findTestObject('Homepage menu/News Active select page/Search Result/img_page3'), 
    20)
