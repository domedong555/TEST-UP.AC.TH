...
WebUI.verifyElementPresent(findTestObject('Homepage menu/News Active select page/Search Result/img_next'), 
    20)

WebUI.verifyElementPresent(findTestObject('Homepage menu/News Active select page/Search Result/a_next'), 
    20)
