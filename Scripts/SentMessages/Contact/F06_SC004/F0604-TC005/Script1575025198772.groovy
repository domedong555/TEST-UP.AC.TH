...
WebUI.click(findTestObject('SentMessages/HOUP/a__4'))

WebUI.setText(findTestObject('SentMessages/Function/input_name'), GlobalVariable.GS_name + randomValue)

WebUI.setText(findTestObject('SentMessages/Function/input_email'), (GlobalVariable.GS_name + randomValue2) + GlobalVariable.GS_add)

WebUI.setText(findTestObject('SentMessages/Function/input_title'), GlobalVariable.GS_title)

WebUI.setText(findTestObject('SentMessages/Function/input_textarea'), randomValue2 * 1001)
