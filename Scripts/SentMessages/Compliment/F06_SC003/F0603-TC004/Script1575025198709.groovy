...
WebUI.setText(findTestObject('SentMessages/Function/input_email'), (GlobalVariable.GS_name + randomValue2) + K)

WebUI.setText(findTestObject('SentMessages/Function/input_title'), GlobalVariable.GS_title)

WebUI.setText(findTestObject('SentMessages/Function/input_textarea'), randomValue2)
