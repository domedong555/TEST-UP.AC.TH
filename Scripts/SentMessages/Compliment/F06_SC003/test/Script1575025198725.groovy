...
WebUI.click(findTestObject('SentMessages/HOUP/a__3'))

WebUI.setText(findTestObject('SentMessages/Function/input_name'), name)

WebUI.setText(findTestObject('SentMessages/Function/input_email'), mail)

WebUI.setText(findTestObject('SentMessages/Function/input_title'), 'Test')

WebUI.setText(findTestObject('SentMessages/Function/input_textarea'), randomValue * 1001)
