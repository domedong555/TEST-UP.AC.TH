...
WebUI.click(findTestObject('แสดงผลแถบเมนู/personel/policy/หลักเกณฑ์การบริหารและพัฒนาทรัพยากรบุคคล'))
WebUI.delay(1)

///Check policy page
WebUI.verifyElementPresent(findTestObject('แสดงผลแถบเมนู/personel/policy/ตรวจสอบหลักเกณฑ์การบริหารและพัฒนาทรัพยากรบุคคล'),20)
WebUI.delay(1)
WebUI.closeBrowser()