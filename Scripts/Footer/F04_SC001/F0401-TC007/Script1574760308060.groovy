...
WebUI.verifyElementPresent(findTestObject('Footer/Related links/07Evaluation'),10)
WebUI.click(findTestObject('Footer/Related links/07Evaluation'))
...
WebUI.delay(1)
//Check text
WebUI.verifyTextPresent('ข่าว/ประกาศ', false)
